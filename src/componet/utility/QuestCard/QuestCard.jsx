        ...
        <CardBody padding={2}>
            <VStack>
                <Flex w={FILL_PARENT} justifyContent={SB} alignItems={"center"}>
                    <Button _hover={{bg:TRANSPARENT}} _active={{bg:TRANSPARENT}} bg={TRANSPARENT} fontSize={"11px"} leftIcon={<Image borderRadius={"100px"} w={"16px"} src={cimage}></Image>}>{cname}</Button>
                ...
                <Flex w={FILL_PARENT} justifyContent={"end"} >
